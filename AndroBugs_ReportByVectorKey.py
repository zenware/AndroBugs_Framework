...
def parseArgument():
    parser = argparse.ArgumentParser(
        description='AndroBugs Framework: Android APK Vulnerability Reporter by Vector Name')
    ...
    parser.add_argument("-l", "--log_level", help="Specify \"Critical\", \"Warning\", \"Notice\" or \"Info\"", type=str,
                        required=True)
    parser.add_argument("-a", "--ALL", help="Specify this argument if you want to see the apps for all the log level.",
                        action="store_true")
...
collection_Analyze_Success_Results_FastSearch = db[
    Collection_Analyze_Success_Results_FastSearch]  # Name is case-sensitive
